...
--
-- Table structure for table `tbl_dia_practica`
--

DROP TABLE IF EXISTS `tbl_dia_practica`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_dia_practica` (
  `id` int(11) NOT NULL,
  `dia` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `tbl_dia_practica`
--

LOCK TABLES `tbl_dia_practica` WRITE;
/*!40000 ALTER TABLE `tbl_dia_practica` DISABLE KEYS */;
INSERT INTO `tbl_dia_practica` VALUES (1,'Lunes'),(2,'Martes'),(3,'Miércoles'),(4,'Jueves'),(5,'Viernes'),(6,'Sábado'),(7,'Domingo'),(8,'Interdiario'),(9,'Fin de Semana'),(10,'Todos los Días'),(11,'Días Hábiles'),(12,'Otros');
/*!40000 ALTER TABLE `tbl_dia_practica` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_hora_practica`
--

DROP TABLE IF EXISTS `tbl_hora_practica`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_hora_practica` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_hora_practica`
--

LOCK TABLES `tbl_hora_practica` WRITE;
/*!40000 ALTER TABLE `tbl_hora_practica` DISABLE KEYS */;
INSERT INTO `tbl_hora_practica` VALUES (1,'Matutino'),(2,'Vespertino'),(3,'Nocturno');
/*!40000 ALTER TABLE `tbl_hora_practica` ENABLE KEYS */;
UNLOCK TABLES;
