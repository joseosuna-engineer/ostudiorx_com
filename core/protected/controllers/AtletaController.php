...
class AtletaController extends Controller
{
	...
	/**
	 * Al Crear un atleta todos los modelos de datos asociados a �l se crean (inicializan)
	 */
	public function actionCreate()
	{
		...
		// El nuevo atleta s�lo cuenta con 7 datos criticos
		// c.i., 1� nombre, 1� apellido, sector al que pertenece el atleta,
		// escuela (no obligatorio), a�o ingreso a la educaci�n superior, disciplina, el resto es vacio
		// para crear cada tabla relacionada s�lo hace falta el c.i.
	...
	public function loadModel($id,$md)
	{
		...
		if($model===null)
			throw new CHttpException(404,'El Atleta requerido no est� registrado.');
		return $model;
	}
